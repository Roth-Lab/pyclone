...
class Test(unittest.TestCase):
    def test_left_endpoint(self):
        ...
        bin_centres, counts = histogram(values, num_bins=2, min_value= -1, max_value=1)
    ...
    def test_counts_vs_numpy(self):
        ...
        for left, right in [(-2, -1), (-0.5, 0.5), (1, 2), (100, 1000)]:    
            ...
            bin_centres, counts = histogram(values, num_bins=bins, min_value=left, max_value=right)
    ...
    def test_normalise_vs_numpy(self):
        ...
        for left, right in [(-2, -1), (-0.5, 0.5), (1, 2), (100, 1000)]:    
            ...
            bin_centres, counts = histogram(values, num_bins=bins, min_value=left, max_value=right, normalise=True)
    ...
    def test_values_less_than_min(self):
        ...
        bin_centres, counts = histogram(values, num_bins=2, min_value= 0, max_value=1)
