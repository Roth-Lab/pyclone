...
from pydp.data import BinomialData
from pydp.densities import BinomialDensity
...
def run_ibmm_analysis(config_file, trace_dir, num_iters, alpha, alpha_priors):
    ...
    for sample_id in sample_ids:
        ...
        sample_cluster_densities[sample_id] = BinomialDensity()
        
        sample_atom_samplers[sample_id] = BetaBinomialGibbsAtomSampler(sample_base_measures[sample_id], 
